    ...
    <div className="h-full flex flex-col bg-[oklch(0.11_0.02_260)]">
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border shrink-0">
        ...
        >
          ...
          <option value="suggest" className="bg-background text-foreground">
            Suggest
          </option>
          <option value="apply" className="bg-background text-foreground">
            Apply w/ Approval
          </option>
          <option value="autonomous" className="bg-background text-foreground">
            Autonomous
          </option>
          <option value="autopilot" className="bg-background text-foreground">
            Full Autopilot
          </option>
        </select>
