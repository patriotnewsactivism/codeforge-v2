...
const SWARM_PROFILES = [
  ...
  },
  {
    ...
    description:
      "Claude Opus 4.8 architecting and reviewing, GPT-4.1 Mini doing the heavy lifting of code generation. Extremely robust but pricier.",
    reasoning: 5,
    speed: 3,
    priceLevel: 5,
    ...
    icon: Shield,
    roles: {
      "Planner / Architect": "Claude Opus 4.8",
      Coder: "GPT-4.1 Mini",
  ...
  },
  {
    ...
    description:
      "o4-mini reasons about the high-level architecture, DeepSeek R1 executes code logic with deep chain-of-thought, and Claude Haiku 4.5 reviews.",
    reasoning: 5,
    speed: 3,
    priceLevel: 3,
    ...
    icon: Brain,
    roles: {
      "Planner / Architect": "OpenAI o4-mini",
      Coder: "DeepSeek R1",
      Reviewer: "Claude Haiku 4.5",
