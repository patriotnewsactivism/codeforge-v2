...
export const analyzeScreenshot = action({
  ...
  handler: async (ctx, { imageBase64, mode, projectId }) => {
    ...
    const modePrompts: Record<string, string> = {
      build:
        "Describe this UI in detail: layout, components, colors, spacing, interactions. Be specific enough that a developer could recreate it.",
      ...
      analyze:
        "Analyze this screenshot and suggest 3-5 specific improvements for: UX, performance, accessibility, and visual design.",
    };
