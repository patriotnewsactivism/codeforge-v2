...
export const pollPRStatus = action({
  ...
  handler: async (ctx, args) => {
    if (!GITHUB_TOKEN) {
      return { ciStatus: "unknown", checkSummary: "GITHUB_TOKEN not configured", readyForDeploy: false };
    }
    ...
    try {
      ...
      if (!allDone) {
        ...
        return { ciStatus: "running", checkSummary: summary, readyForDeploy: false };
      }
      ...
      if (anyFailed) {
        ...
        return { ciStatus: "failure", checkSummary: summary, readyForDeploy: false };
      }
      ...
      return { ciStatus: "success", checkSummary: summary, readyForDeploy: true };
