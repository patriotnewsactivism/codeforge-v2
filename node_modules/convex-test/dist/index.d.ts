import { DataModelFromSchemaDefinition, FunctionReference, FunctionReturnType, GenericDataModel, GenericMutationCtx, GenericSchema, OptionalRestArgs, SchemaDefinition, StorageActionWriter, UserIdentity } from "convex/server";
...
export type TestConvexForDataModel<DataModel extends GenericDataModel> = {
     ...
     */
    run: <Output>(func: (ctx: GenericMutationCtx<DataModel> & {
